...
int main (int argc, char *argv[])
{
  ...
  std::string dataRateString = "120Kbps";
      ...
      */
      ...
      for (uint16_t i = 0; i < num_flows; i++)
        { 
          ...
          AddressValue remoteAddress (InetSocketAddress (sink_interfaces.GetAddress (i), port));
        ...
        //std::cout<<"Reached here\n";
          ...
          xmlName<<"1705038_taskA_802_11_nodes"<< num_nodes<< "_flows"<< num_flows <<"_datarate"<<dataRateString<<
