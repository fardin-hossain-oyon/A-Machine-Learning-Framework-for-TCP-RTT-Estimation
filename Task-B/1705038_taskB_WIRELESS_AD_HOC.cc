...
int main (int argc, char *argv[])
{
  ...
  std::string rtt_tr_file_name = "adhoc_RTT.trace";
  std::string rto_tr_file_name = "";
  std::string rttvar_tr_file_name = "";
  std::string rrtt_tr_file_name = "adhoc_realRTT.trace";
  std::string delta_tr_file_name = "adhoc_delta.trace";

  std::string rtt_tr_file_name_2 = "";

  std::string fixed_share_rtt_tr_file_name = "adhoc_fixedShareRTT.trace";
...
*/
    ...
    //ipv6.NewNetwork();
    Ipv4InterfaceContainer node_interfaces = ipv4.Assign (devices);
      ...
      */
      ...
      for (uint16_t i = 0; i < num_flows; i++)
        { 
          ...
          AddressValue remoteAddress (InetSocketAddress(node_interfaces.GetAddress (num_flows+i), port));
        ...
        //std::cout<<"Reached here\n";
              ...
              if (tr_file_name.compare ("") != 0)
                {
                  ...
                  internet.EnableAsciiIpv6All (ascii_wrap);
                }
          ...
          xmlName<<"adhoc_nodes"<< num_nodes<< "_flows"<< num_flows <<".flowmonitor";
