...
protected:
  ...
  double m_expert_predictions[100];         //prediction of the experts (array of x's)
  double m_learning_rate;                   //learning rate (iota)
  double m_weights[100];                    //array of weights
  Time m_prediction;                        //output of the algorithm
  double m_exponential_updates[100];        //array to store exponential update of weights
  double m_pool;                            //pool variable to update weights
  double m_loss_function_values[100];       //value of the loss functions for each expert
  double m_minRTT;                          //minimum value of RTT
  double m_maxRTT;                          //maximum value of RTT
  double m_expert_alpha;                    //alpha value for fixed share experts
